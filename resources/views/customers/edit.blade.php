...
@section('content')
    <div class="max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Edit Customer</h2>
        ...
        <div class="bg-white rounded shadow p-8">
            <form action="{{ route('customers.update', $customer) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="factory_number" value="{{ old('factory_number', $customer->factory_number) }}" required
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="town" value="{{ old('town', $customer->town) }}" required
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('customers.show', $customer) }}" class="bg-gray-400 text-white px-6 py-2 rounded hover:bg-gray-500 transition">
